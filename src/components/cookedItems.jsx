  ...
  return (
    <div className="mt-10 grid">
      ...
      <div className="flex  justify-center  sm:gap-32 gap-12  relative sm:left-0 left-6">
        <p className="relative sm:left-10 left-0">Name</p>
        <p className="relative ml-10 sm:left-20 left-0">Time</p>
        <p className="relative sm:left-[70px] left-0">Carlos</p>
      </div>
      {preperdItems.map((item, index) => (
        <div key={index} className="flex bg-green-100 shadow-md
         mt-2 rounded-md gap-2 justify-center items-center">
          <p className="text-2xl font-bold relative sm:left-6 pl-2">{index+1}</p>
